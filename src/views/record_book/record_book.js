...
function getFilterData() {
  return new Promise(async (resolve, reject) => {
    var newFiltro = {
      ...
      fechaEmision1: await obtenerValorInfinito((new Date(document.getElementById('fechaEmision1').value)).getTime(), true),
      fechaEmision2: await obtenerValorInfinito((new Date(document.getElementById('fechaEmision2').value)).getTime(), false),
      fechaVencimiento1: await obtenerValorInfinito((new Date(document.getElementById('fechaVencimiento1').value)).getTime(), true),
      fechaVencimiento2: await obtenerValorInfinito((new Date(document.getElementById('fechaVencimiento2').value)).getTime(), false),
